...
export class RechercheComponent {
  ...
  search() {
    ...
    this.http.get('https://127.0.0.1:8000/articles/rechercher?q=' + this.form.get('designation')?.value + '&q1=' + this.form.get('idcategorie')?.value ).subscribe(data => {
